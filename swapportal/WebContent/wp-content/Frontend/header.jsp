                ...
                <div class="row">
                    <div class="col-sm-4 hidden-xs">
                        <div class="top-bar-socials">
                            <a href="https://www.facebook.com/RSY111/" class="social-icon-sm si-dark si-gray-round si-colored-facebook">
                    ...
                    <div class="col-sm-8 text-right">
                        <ul class="list-inline top-dark-right">                      
                            ...
                            <li><a href="<%=request.getContextPath() %>/wp-content/Frontend/userlogin.jsp"><i class="fa fa-lock"></i> Login</a></li>
