...
<!--                 </div>/.nav-collapse -->
            ...
            <div class="row">  
                <div class="col-md-8 col-sm-12 col-md-offset-2 col-sm-offset-2">
                    <div class="login-form">
                        <h3><span>Investor profile</span></h3>
                         <form role="form" action="<%=request.getContextPath() %>/FileUploadDBServlet?id=<%=regi.getId() %>" method="post" name="investor" onsubmit="return validate()" enctype="multipart/form-data">
                         <input  type="hidden" name="actionCode" value="addInvestor">
                        		 
						 <div class="form-group">
						
                            <label class="col-md-3 col-xs-12 control-label">Email<font color=red>*</font></label>
                            <input type="text" Disabled class="form-control" value="<%=regi.getEmail() %>" name="email"/>
	...
	<option >Communications-Publishing</option>
	<option >Computer Hardware</option>
	<option  selected="selected">Computer Software</option>
	<option >Construction</option>
	<option >Consumer Durables and Non-Durables</option>
	<option >Drugs</option>
	...
	<option >Mobile App-Web App</option>
	<option >Nanotechnology</option>
	<option >Oil-Gas Production</option>
	<option >Property</option>
	<option >Retail</option>
	<option >Service - Biz and Personal</option>
	...
	<option >Utilities</option>  
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="inam"/>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">Logo</label>
                            <input type="file" class="fileinput btn-primary" name="photo" id="filename"/>
                        </div>
