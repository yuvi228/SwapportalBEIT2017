                ...
                <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                    <div class="login-form">
                        <h3><span>Post Idea</span></h3>
                         <form role="form" action="<%=request.getContextPath() %>/Controller?id=<%=regi.getId() %>" method="post">
                         <input type="hidden" name="actionCode" value="addIdea">
						
						<div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">Registered Id<font color=red>*</font></label>
                            <input type="text" Disabled class="form-control" name="id" value="<%=regi.getId() %>"/>
                        </div>
						<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="col-md-4 col-xs-12 form-control " name="pk"/>
                        </div><br/><br/><br/>
                        <div class="form-group">
	...
	<option value="47">Utilities</option>  
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" value="2015-11-01" namae="esd">
                        </div>
                        <div class="form-group">
