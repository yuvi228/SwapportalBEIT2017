            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 text-center">
                        <div class="person-v2">
                            <img src="<%=request.getContextPath() %>/assets/images/users/rm.JPG" class="img-responsive" alt="">
                    ...
                    <div class="col-sm-4 text-center">
                        <div class="person-v2">
                            <img src="<%=request.getContextPath() %>/Image/shivam.jpg" class="img-responsive" alt="">
                            <div class="person-desc-v2">
