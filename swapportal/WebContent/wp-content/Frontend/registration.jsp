...
<div class="breadcrumb-wrapper">
            <div class="container">
                <h1 style="padding-top: 15px;">Register</h1>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="sky-form-login">
                      ...
                      <input type="hidden" name="actionCode" value="addRegister">
                            <h3 class="text-left"> &nbsp;&nbsp;&nbsp;<i class="fa fa-user" style="margin-left: 30px; margin-top: 15px;">&nbsp;&nbsp;&nbsp; </i>Create new account with Swap Portal</h3>
                            ...
                            <section>
                               ...
                               <section>
                                ...
                                <section>
                                    <label class="input">
                                        <i class="icon-append fa fa-lock"></i>
                                        <input type="password" name="rps" placeholder="Confirm password">
                                ...
                                <button  style="background-color: #52CCE1; height:20px; width:200px;" type="submit" class="btn btn-skin btn-lg">Sign UP</button>
                ...
                <div class="col-md-6">
                    <div class="login-register-aside-box">
                        ...
                        <br>
                        <a style="background-color: #52CCE1" href="<%=request.getContextPath() %>/wp-content/Frontend/userlogin.jsp" class="btn btn-dark btn-lg">Sign In</a>
