...
<body background="<%=request.getContextPath()%>/Image/bg.jpg"
	...
	<div class="col-sm-3 margin40">
		<ul class="list-unstyled side-nav">
			...
			<li><a
				href="<%=request.getContextPath()%>/Controller?actionCode=editinvestor&id=<%=regi.getId()%>"><i
		...
		<div class="panel panel-default">
			<div class="panel-body profile"
				...
				<div class="profile-image" style="border-radius: 50%; float: left;">
					...
					<img
						src="<%=request.getContextPath()%>/wp-content/Frontend/getImage.jsp?id=<%=id%>" style="width: 150px; height: 150px; margin: 0px auto;">
					...
					<font color="black">
						<table style="border-style: solid;" width="100%" cellspacing="100">
							<tr>
								<td width="20%" align="right"><label
									class="col-md-12 col-xs-12 control-label"> Registered
										ID</label></td>
								<td><label class="col-md-12 col-xs-12 control-label"><%=inve.getId()%></label>
								</td>
							</tr>
							...
							<tr>
								<td width="20%" align="right"><label
									class="col-md-12 col-xs-12 control-label">Investing
										Amount</label></td>
								<td><label class="col-md-12 col-xs-12 control-label"><%=inve.getInvestingamount()%></label>
								</td>
							</tr>
							<tr>
								<td width="20%" align="right"><label
									class="col-md-12 col-xs-12 control-label">Address1</label></td>
								<td><label class="col-md-12 col-xs-12 control-label"><%=inve.getAddress1()%></label>
								</td>
							</tr>
							<tr>
								<td align="right"><label
									class="col-md-12 col-xs-12 control-label">Address2</label></td>
								<td><label class="col-md-12 col-xs-12 control-label"><%=inve.getAddress2()%></label>
								</td>
							</tr>
							...
							<tr>
								...
								<td><label class="col-md-12 col-xs-12 control-label"><%=inve.getStreet()%></label>
								</td>
							</tr>
							<tr>
								<td align="right"><label
									class="col-md-12 col-xs-12 control-label">City</label></td>
								<td><label class="col-md-12 col-xs-12 control-label"><%=inve.getCity()%></label>
								</td>
							</tr>
							<tr>
								<td align="right"><label
									class="col-md-12 col-xs-12 control-label">Country</label></td>
								<td><label class="col-md-12 col-xs-12 control-label"><%=inve.getCountry()%></label>
								</td>
							</tr>
						</table>
					</font>
