            ...
            <div class="tp-banner">
                <ul>
                    <!-- SLIDE -->
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="<%=request.getContextPath() %>/img/showcase-4.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                       ...
                       <center> SWAP PORTAL <br/><br/><br/><br/><br/>
                            Perfect for startup </center>
                        </div>
                        ...
                        <div class="caption text-center-btm sfr text-center"
                         ...
                         <center>   A Social Online Platform for great ideas and Startups </center>
                    ...
                    <li data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Powerful Theme">
                        <!-- MAIN IMAGE -->
                        <img src="<%=request.getContextPath() %>/img/bg-3.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        <div class="caption title-2 sft"
                             ...
                             data-start="1000"
                             data-easing="easeOutExpo">
                            Every problem has a solution.<br/> You just have to be creative<br/> enough to find it. <br>
...
<!--                         </div> -->
                    ...
                    <li data-transition="fade" data-slotamount="5" data-masterspeed="1000" data-title="Multipurpose">
                        <!-- MAIN IMAGE -->
                        <img src="<%=request.getContextPath() %>/img/bg-1.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        <!-- LAYER NR. 1 -->
                        <div class="caption left-tile-text sfr tp-resizeme"
                             ...
                             data-start="1200"
                             data-end="9400"
                             data-endspeed="600">Core Features
                        </div>
                        ...
                        <div class="caption modern_big_redbg sfb medium tp-resizeme"
                             ...
                             data-start="1800"
                             data-end="9400"
                             data-endspeed="600">Social Media Integretion
                        </div>
                        ...
                        <div class="caption modern_big_redbg sfb medium tp-resizeme"
                             ...
                             data-start="2000"
                             data-end="9400"
                             data-endspeed="600">Creative Projects
                        </div>
                        ...
                        <div class="caption modern_big_redbg sfb medium tp-resizeme"
                             ...
                             data-start="2200"
                             data-end="9400"
                             data-endspeed="600">Unique Platform
                        </div>
...
<!--             <div class="divide50"></div> -->
            ...
            <div class="row margin-0 wide-img-showcase-row">
                ...
                <div class="col-sm-6 col-sm-offset-6 no-padding gray">
                    <div class="no-padding-inner gray">
                        <h3 class="wow animated fadeInDownfadeInRight">Core features of <span class="colored-text">Swap Portal</span></h3>
                        ...
                        <div class="services-box margin30 wow animated fadeInRight">
                            ...
                            <div class="services-box-info">
                                ...
                                <p>
                                    Users can directly connect through Social Media to this Portal.
                                </p>
                            </div>
                        </div><!--service box-->
                        ...
                        <div class="services-box margin30 wow animated fadeInRight">
                            ...
                            <div class="services-box-info">
                                ...
                                <p>
                                    Users can see the Different, Creative , Unique ideas and projects.
                                </p>
                            </div>
                            <div class="divide30"></div>
                            <p><a href="#" class="btn btn-theme-dark btn-lg">All Projects</a></p>
                        </div><!--service box-->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="testi-slide">
                            <ul class="slides">
                                <li>
                                    <img src="<%=request.getContextPath() %>/Image/dipen.jpg" alt="">
                                    <p>
                                        <i class="ion-quote"></i>
                                        It is a greate plateform to get investor easily for any field of idea / projects. 
                                    </p>
                                ...
                                <li>
                                    <img src="<%=request.getContextPath() %>/Image/icon.png" alt="">
                                    <p>
                                        <i class="ion-quote"></i>
                                        I am searching for investor to provide funding for my project as i know about this portal and i go through it. Even I got investor for my other project as well. 
                                          <h4 class="test-author">
                                        Vihang Shah - <em>Founder of ItBpoCareer</em>
                                    </h4>
                                </li><!--testi item-->
                                <li>
                                    <img src="<%=request.getContextPath() %>/Image/sachin.jpg" alt="">
                                    <p>
                                        <i class="ion-quote"></i>
                                        I am looking to invest some money in such field which get good result to our society. In this portal i show one greate/ Innovative Idea of my interesting field. So I can invest my money in this project.
                                        <h4 class="test-author">
        ...
        <script type="text/javascript" src="<%=request.getContextPath() %>/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
        <script type="text/javascript" src="<%=request.getContextPath() %>/js/revolution-custom.js"></script>
        <!--cube portfolio plugin-->
        <script src="<%=request.getContextPath() %>/cubeportfolio/js/jquery.cubeportfolio.min.js" type="text/javascript"></script>
        <script src="<%=request.getContextPath() %>/js/cube-portfolio.js" type="text/javascript"></script>
        <script src="<%=request.getContextPath() %>/js/pace.min.js" type="text/javascript"></script>
