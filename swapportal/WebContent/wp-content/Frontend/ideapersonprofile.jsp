            ...
            <div class="container" >
                <div class="row">
                    ...
                    <div class="col-sm-6 hidden-xs text-right">
                        <ol class="breadcrumb">
                            <li><a href="<%=request.getContextPath() %>/wp-content/Frontend/ideapersondashboard.jsp">Home</a></li>
          ...
          <div class="col-sm-2 " >
                    ...
                    <ul class="list-unstyled side-nav">
                        ...
                        <li><a href="<%=request.getContextPath() %>/wp-content/Frontend/ideapersondashboard.jsp"><i class="fa fa-dashboard"></i> Dashboard</a></li>
              			<li><a href="<%=request.getContextPath() %>/wp-content/Frontend/searchproposal.jsp"><i class="fa fa-search"></i> Search Proposal</a></li>
                  </ul>
            ...
            <div class="row">  
                <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                    <div class="login-form">
                        <h3><span>Idea person profile</span></h3>
                     
                         <form role="form" action="<%=request.getContextPath() %>/FileUploadDBServlet?id=<%=regg.getId() %>" method="post" name="ideaperson" onsubmit="return validate()" enctype="multipart/form-data">
						...
						<div class="form-group" class="col-2">
                            ...
                            <input type="text" Disabled class="form-control" name="email" value="<%=regg.getEmail() %>"/>
                          </div>
                         <div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">Name<font color=red>*</font></label>
                            <input type="text" Disabled class="form-control" name="name" value="<%=regg.getName() %>"/>
                        </div>
                           <%
				}
          } 
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="fileinput btn-primary" name="photo" id="filename" title="Browse file"/>
                        </div>
                         <div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">About You <font color=red>*</font></label>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">Expect Fund<font color=red>*</font></label>
                            <input type="text" class="form-control" name="expfund"/>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">Addressline1<font color=red>*</font></label>
                            <input type="text" class="form-control" name="adrs1"/>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-theme-bg">Save Profile</button>
