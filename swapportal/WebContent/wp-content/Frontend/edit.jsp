...
<body background="<%=request.getContextPath()%>/Image/bg.jpg">
			...
			<div class="registration-box animated fadeInDown">
				...
				<div class="registration-body">
					<div class="registration-title">
						<strong>Edit Information</strong>, use form below
					</div>
					<div class="registration-subtitle"></div>

					<form
						action="<%=request.getContextPath()%>/Authcontroller?id=<%=reg.getId()%>"
						...
						<div class="form-group">
							<div class="col-md-6">
								<select class="form-control select" name="st" disabled>
									<option value="" <%=reg.getType() == null ? "selected" : ""%>>Select
										Type</option>
									<option value="Investor"
										<%="Investor".equals(reg.getType()) ? "selected" : ""%>>Investor</option>
									<option value="Ideaperson"
										<%="Ideaperson".equals(reg.getType()) ? "selected" : ""%>>Idea
										Person</option>
				...
				<div class="registration-footer">
					<div class="pull-left">&copy; 2016 Swap Portal</div>
	...
	<script type='text/javascript'
		src='<%=request.getContextPath()%>/js/plugins/bootstrap/bootstrap-datepicker.js'></script>
	...
	<noscript>
		<div>
			<img src="https://mc.yandex.ru/watch/25836617"
