...
<body style="background-attachment: fixed;"
		...
		<div class="container">
			<div class="navbar-header">
				...
				<img src="<%=request.getContextPath()%>/Image/swlogo.jpg"
					...
					alt="A Social Online Platform for great ideas and Startups"><b>A
					Social Online Platform for great ideas and Startups</b>
			</div>
	...
	<!--breadcrumbs-->
	<center>
		<table style="text-align: center;" align="center" cellpadding="100"
			...
			<tr>
				...
				<td><a
					href="<%=request.getContextPath()%>/Controller?actionCode=getallIdeaperson"><i
						class="fa fa-dashboard fa-5x"></i><br>Idea Person Profile
						data</a></td>
<!-- 				<td><a -->
<%-- 					href="<%=request.getContextPath()%>/wp-content/Frontend/postidea.jsp"><i --%>
<!-- 						class="fa fa-plus fa-5x"></i><br>Add Idea</a></td> -->

				<td><a
					href="<%=request.getContextPath()%>/Controller?actionCode=getallIdea"><i
						class="fa fa-cogs fa-5x"></i><br>Idea Manager</a></td>
			</tr>
			<tr>
				<td><a
					href="<%=request.getContextPath()%>/Controller?actionCode=getallInvestor"><i
						class="fa fa-cogs fa-5x"></i><br> Investor profile data</a></td>

				<td><a
					href="<%=request.getContextPath()%>/Controller?actionCode=getallfeedback"><i
						class="fa fa-cogs fa-5x"></i><br>FeedBack Manage</a></td>
				<td><a
