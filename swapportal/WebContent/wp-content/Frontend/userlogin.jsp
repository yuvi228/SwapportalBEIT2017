            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="sky-form-login">
                        <form action="<%=request.getContextPath() %>/Controller"  class="sky-form" method="post" onsubmit="return validate()" name="reg">
                        <input type="hidden" name="actionCode" value="addLogin">

                            <h3 class="text-left"><i class="fa fa-unlock" style="margin-left: 30px; margin-top: 10px;"></i>Log in to your account</h3>
                            <fieldset>					
                                <section>
                                    <div class="row">
                                ...
                                <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-8">
                                            ...
                                            <div class="note"><a href="<%=request.getContextPath() %>/wp-content/Frontend/forgot.jsp" class="modal-opener">Forgot password?</a></div>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section>
                                    <div class="row">
                                        ...
                                        <div class="col col-8">
                                            <label class="checkbox"><input type="checkbox" style="background-color: #52CCE1;" name="remember">Keep me logged in</label>
                                        </div>
                                    </div>
                                </section>
                            </fieldset>
                            <footer class="text-right">
<%--                                 <a href="<%=request.getContextPath() %>/wp-content/Frontend/registration.jsp" class="btn btn-link">Register</a> --%>
                                <button style="background-color: #52CCE1; width: 100px; height: 30px;" type="submit" class="btn btn-lg btn-skin">Sign In</button>
                ...
                <div class="col-md-6">
                    <div class="login-register-aside-box">
                        ...
                        <br>
                        <a style="background-color: #52CCE1" href="<%=request.getContextPath() %>/wp-content/Frontend/registration.jsp" class="btn btn-light-dark btn-lg" >Sign Up</a>
                    </div>
                </div>
            </div>
        </div>
