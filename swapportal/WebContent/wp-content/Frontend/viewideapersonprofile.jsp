...
<!--                 </div>/.nav-collapse -->
 		...
 		<div class="col-sm-3 margin40">
					<ul class="list-unstyled side-nav">
						<li><a href="<%=request.getContextPath() %>/Controller?actionCode=editideaperson&id=<%=regi.getId()%>"><i class="fa fa-user"></i>Edit Profile</a></li>
					    <li><a href="<%=request.getContextPath() %>/wp-content/Frontend/ideapersondashboard.jsp"><i class="fa fa-dashboard"></i> Dashboard</a></li>
...
<div class="col-md-9" style="margin-top: 10px;">
					...
					%>
                                    ...
                                    <div class="profile-data" style="float: left; margin-left: 100px" >
                                        ...
                                        <div class="profile-data-name"><h4><i>Phone:-</i> <%=regi.getPhone() %></h4></div>
                                        <div class="profile-data-title"><h4><i>Email:-</i> <%=regi.getEmail() %></h4></div>
                                    </div>
                                    <%
 					}
 					}
...
%>
				 ...
				 <% 
					...
					%>	
                                        ...
                                        <div class="profile-data-name"><h4><i>Type:-</i> <%=idd.getType() %></h4></div>
<%--                                         <div class="profile-data-title"><%=inve.getAreaofinterest() %></div> --%>
                                        <div class="profile-controls">
                                        <a href="<%=idd.getTw() %>" class="profile-control-left twitter"><span class="fa fa-twitter fa-2x" ></span></a>&nbsp; &nbsp;&nbsp;
                                        <a href="<%=idd.getFb() %>" class="profile-control-center facebook"><span class="fa fa-facebook fa-2x"></span></a>&nbsp; &nbsp;&nbsp;
                                        <a href="<%=idd.getGg() %>" class="profile-control-right googleplus"><span class="fa fa-google-plus fa-2x"></span></a>
                                    </div> 
                                    </div>
                        ...
                        <label class="col-md-12 col-xs-12 control-label"> Registered ID</label>
                        </td>
                        <td>
                        <label class="col-md-12 col-xs-12 control-label"><%=idd.getId() %></label>
                        </td>
                        </tr>
                        <tr>
                        <td width="20%" align="right">
                        <label class="col-md-12 col-xs-12 control-label">About You</label>
                        </td>
                        <td>
                        <label class="col-md-12 col-xs-12 control-label"><%=idd.getAboutyou() %></label>
                        </td>
                        </tr>
                        <tr>
                        <td width="20%" align="right">
                        <label class="col-md-12 col-xs-12 control-label">Project Abstract</label>
                        </td>
                        <td>
                        <label class="col-md-12 col-xs-12 control-label"><%=idd.getProjectabstract() %></label>
                        </td>
                        </tr>
                        <tr>
                        <td width="20%" align="right">
                        <label class="col-md-12 col-xs-12 control-label">Expected Funding</label>
                        </td>
                        <td>
                        <label class="col-md-12 col-xs-12 control-label"><%=idd.getExpectfund() %></label>
                        </td>
                        </tr>
                        <tr>
                        <td width="20%" align="right">
                        ...
                        <td>
                        <label class="col-md-12 col-xs-12 control-label"><%=idd.getAddress1() %></label>
                        </td>
                        </tr>
                        <tr>
                        <td align="right">
                        ...
                        <td>
                        <label class="col-md-12 col-xs-12 control-label"><%=idd.getAddress2() %></label>
                        </td>
                        </tr>
                        
                        <tr>
                        <td align="right">
                        <label class="col-md-12 col-xs-12 control-label">Street</label>
                        </td>
                        <td>
                        <label class="col-md-12 col-xs-12 control-label"><%=idd.getStreet() %></label>
                        </td>
                        </tr>
                        <tr>
                        <td align="right">
                        <label class="col-md-12 col-xs-12 control-label">City</label>
                        </td>
                        <td>
                        <label class="col-md-12 col-xs-12 control-label"><%=idd.getCity() %></label>
                        </td>
                        </tr>
                        <tr>
                        <td align="right">
                        <label class="col-md-12 col-xs-12 control-label">Country</label>
                        </td>
                        <td>
                        <label class="col-md-12 col-xs-12 control-label"><%=idd.getCountry() %></label>
                        </td>
                        </tr>
...
%>
      ...
      <script src="<%=request.getContextPath() %>/js/jquery.min.js"></script>       
        ...
        <script src="<%=request.getContextPath() %>/js/ideaperson.js" type="text/javascript"></script>
