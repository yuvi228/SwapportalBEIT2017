		...
		<div class="row">
			<div class="col-md-12">
				<div class="center-heading">
					...
					<p class="lead">If you have any question regarding our website
						than you can check out the solution given below.</p>
				</div>
				<!--center-heading-->
			</div>
		</div>
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#collapseOne"> How can i register? </a>
							</h4>
						</div>
						<div id="collapseOne" class="panel-collapse collapse in">
							<div class="panel-body">
								First you have to make your paid account. If you are visitor
								than you don't have to register. you can visit our website. now
								if you are an idea person then you have to register yourself as
								a <b>Idea Person</b> and if you are a investor then register
								yourself as a Investor in the Registration tab.
							</div>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#collapseTwo"> Is registration is free? </a>
							</h4>
						</div>
						<div id="collapseTwo" class="panel-collapse collapse">
							<div class="panel-body">No, because of security reason you
								have to make paid registration. If this will be free then may be
								many fake account will be created and your privacy and security
								will be compromised.</div>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#collapseThree"> What after registraition? </a>
							</h4>
						</div>
						<div id="collapseThree" class="panel-collapse collapse">
							<div class="panel-body">After registraition first you have
								to complete your account. Like you are idea person than you have
								to put idea in you account or on dashboard so investors can see
								about your idea and contact you for your idea and if you are
								investor than you have to write about your company and your
								interesting field for investment so idea will be notify to you.
							</div>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion"
									href="#collapse4"> How this website will help us? </a>
							</h4>
						</div>
						<div id="collapse4" class="panel-collapse collapse">
							<div class="panel-body">From this website if someone have
								idea but does not have money than they can meet investor which
								are registered on our website for develope idea. And investor
								can find their interested area to invest.</div>
						</div>
					</div>
