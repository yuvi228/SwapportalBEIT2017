  ...
  %>
     <%
          if(!inv.isEmpty() && inv!= null){
				...
				Ideaperson inve = null;
				while(it.hasNext()){
				inve = (Ideaperson)it.next();
   			%>
   			<%
                ...
                <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                    <div class="login-form">
                        <h3><span>Idea person profile</span></h3>
                         <form role="form" action="<%=request.getContextPath() %>/FileUploadDBServlet?ipid=<%=inve.getIpid()%>&id=<%=inve.getId() %>" method="post" name="ideaperson" onsubmit="return validate()" enctype="multipart/form-data">
                       ...
                       <div class="form-group">
                            ...
                            <input type="text" Disabled class="form-control" name="id" value="<%=inve.getId() %>"/>
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" name="aboutyou" value="<%=inve.getAboutyou() %>"/></textarea>
                        </div>
                         <div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">Project Abstract<font color=red>*</font></label>
                            <textarea class="form-control" rows="5" name="pa" value="<%=inve.getProjectabstract() %>"/></textarea>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 col-xs-12 control-label">Expect Fund<font color=red>*</font></label>
                            <input type="text" class="form-control" name="expfund" value="<%=inve.getExpectfund() %>"/>
                        </div>
                        <div class="form-group">
